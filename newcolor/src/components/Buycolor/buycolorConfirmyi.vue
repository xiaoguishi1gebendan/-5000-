<template>
				...
				<div class="obet">
					<div class="selectbet">
						...
						<div class="numtext" style="display: block;!important;">
							统一金额<input maxlength="6" style="float: right;
    height: 0.5rem;
    width: 40%;
    line-height: 0.5rem;
    ...
    background: #ffffff;
    margin: 0.05rem 0px 0px 0.1rem;
    font-size: 0.26rem;
    text-indent: 0.05rem;" pattern="[0-9]*" :dataId="index"  class="gl-txt" id="settingAllAmount" type="tel"  onkeyup="value=value.replace(/[\W]/g,'')" placeholder="" value="">
						</div>
					</div>
					<!--注单列表-->
        ...
        <div v-if="!isid" ref="boty" style="position: relative;width:100%;bottom: 90px;">
         ...
         <div v-if="isid" ref="boty" style="position: relative;width:100%;bottom: 120px;">
             <div class="wrap-addto" style="position:absolute;">
					<div class="addto">
						<div class="addto-left fl">
							<!--<label class="labels" for="xxx"><img class="imgAll" src="/source/imgs/wxz.png" alt="" /></label>-->
    ...
    export default{
        ...
        methods:{
            ...
            buyConfirm(){
                ...
                console.log(lotteryJson.lotteryDraw.nextNo)
