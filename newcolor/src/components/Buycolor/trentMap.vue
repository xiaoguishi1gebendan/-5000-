<template>
    <div id="box" style="position:absolute;top:0;width:100%;height:100%;background: white;z-index:1000;overflow: hidden;overflow-x: hidden;">
		  <header class="header12222222222222" style="    position: absolute;">
		  	<div class="color_species">
		  		<a href="javascript:history.go(-1)"><p class="ps" v-show="iszstf"><i class="iconfont"></i></p></a>
		  		<span>{{cound}}</span>
		  ...
		  <main v-if="datacodea=='cqklsf'||datacodea=='gdklsf'" id="main"  style="position: relative;height:100%;margin-top: 0.8rem;padding-bottom:1rem;overflow: scroll;    overflow-x: hidden;">
			 <div style="padding:  0;" class="number_Kj"> 
			 </div>
			 <div style="border-bottom: 2px solid red;font-size:16px;line-height: .6rem;color:red;padding: 10px 0;">
				 <span style="display: inline-block;width: 1rem;height: -0.6rem;line-height: -0.6rem;background-color: #ff6b52;color: white;border-radius: .05rem;">
					 走势
				 </span>
			 </div>
			  <div class="ishppye">
		  ...
		  <main v-else-if="datacodea=='xglhc'||datacodea=='fflhc'||datacodea=='jslhc'" id="main" style="position: relative;    height: 100%;padding-bottom:1rem;margin-top: 0.8rem;overflow: scroll;    overflow-x: hidden;">
			  <div style="padding:  0;" class="number_Kj"> 
			 </div>
			 <div style="border-bottom: 2px solid red;font-size:16px;line-height: .6rem;color:red;padding: 10px 0;">
				 <span style="display: inline-block;width: 1rem;height: -0.6rem;line-height: -0.6rem;background-color: #ff6b52;color: white;border-radius: .05rem;">
		  ...
		  <main v-else-if="datacodea=='ssq'||datacodea=='jsssq'" id="main" style="position: relative;padding-bottom:0.35rem;height: 90%;margin-top: 0.8rem;overflow: scroll;    overflow-x: hidden;">
			 <div style="padding:  0;" class="number_Kj"> 
			 </div>
			 <div style="border-bottom: 2px solid red;font-size:16px;line-height: .6rem;color:red;padding: 10px 0;">
				 <span style="display: inline-block;width: 1rem;height: -0.6rem;line-height: -0.6rem;background-color: #ff6b52;color: white;border-radius: .05rem;">
		  ...
		  <main v-else id="main" style="position: relative;    padding-bottom: .2rem;margin-top: 0.55rem;height: 100%;overflow: scroll;    overflow-x: hidden;">
			<div class="number_Kj"> 
