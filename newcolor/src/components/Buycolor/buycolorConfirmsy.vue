<template>
    <div style="overflow: hidden;position:absolute;top:0;width:100%;height:100%;background: white;z-index:1000;">
		...
		<div id="layout" class="" style="background-color: #f5f5f5;">
			<div class="header_wrap layoutid">
				<div class="header">
			...
			<!--主内容区-->
			<div class="ocontent" id="hkbetlistid" style="position: relative;margin-top:0rem !important;">
				<div class="timecount">
				...
				<div class="obet">
					<div class="selectbet">
						...
						<div class="numtext" style="display: block;!important;">
							统一金额
                            <input style="float: right;height: .5rem;width: 40%;line-height: .5rem;border: 0.01rem solid #ccc;border-radius: 0.04rem;background: #fff;margin: 0.05rem 0 0 .1rem;font-size: 0.26rem;text-indent: 0.05rem;" 
                    ...
                    <ul class="hkbetlist"  style="height: 301px; overflow-y: auto;">
                        <li v-for="(picktherendermin,index) in picktherender" :key="index">
                            ...
                            <div class="liright">
                                <p v-if="picktherendermin.isweishu!=undefined" style="display: flex;align-items: flex-end;flex-wrap: wrap;line-height: 0.5rem;">{{picktherendermin.isweishu|isweishuAll}} {{picktherendermin.xzhm}}</p>
                                <p v-else style="display: flex;align-items: flex-end;flex-wrap: wrap;line-height: 0.5rem;">{{picktherendermin.xzhm}}</p>
                                <div class="licoenten">
                                ...
                                <div class="detail">
                                    ...
                                    :placeholder="picktherendermin.isdanzu"
                                     v-model="picktherendermin.isdanzuval">
                                </div>
                                <div class="">
         ...
         <div v-if="!isid" ref="boty" style="position: relative;width:100%;bottom: 0.8rem;">
             <div class="wrap-addto" style="position:absolute;">
					<div class="addto">
						...
						<img id = "imgs" style="width: 0.4rem;margin-left:0.1rem;" src="../../assets/source/imgs/zq.png" alt="" />
